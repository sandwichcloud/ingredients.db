...
class Database(object):
    def __init__(self, host, port, username, password, database, pool_size, migration_scripts_location=None):
        ...
        self.migration_scripts_location = migration_scripts_location
        self.engine = None
